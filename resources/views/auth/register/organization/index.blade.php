...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('asset/css/organization_register_theme.css') }}">
            ...
            <div class="col-md-8">
                ...
                <div class="card-container">
                    ...
                    <div class="form-container">
                        <form action="{{ route('register.organization.store') }}" method="POST" autocomplete="off" novalidate>
                            @csrf
                            <input type="hidden" name="role" value="organization">
                            <div class="form-floating">
                                <select id="orgType" name="orgType" class="form-select @error('orgType') is-invalid @enderror" required>
                            ...
                            <div class="form-floating">
                                <input type="text" id="orgName" name="orgName" class="form-control @error('orgName') is-invalid @enderror" 
                                    placeholder="Organization name" required value="{{ old('orgName') }}">
                            ...
                            <div class="text-center mb-2 mt-2">
                                <span class="text-green">Administrator account</span>
                            </div>
